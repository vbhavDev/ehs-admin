  ...
  return (
    <div className="relative flex">
      ...
      <input
        ...
        className={`dark:bg-[#0b1a32] h-11 w-full ${
          selectPosition === 'start' ? 'pl-[84px]' : 'pr-[84px]'
        } rounded-lg border border-gray-300 bg-transparent py-3 px-4 text-sm text-gray-800 shadow-theme-xs placeholder:text-gray-400 focus:border-brand-300 focus:outline-hidden focus:ring-3 focus:ring-brand-500/10 dark:border-navy-400 dark:text-white/90 dark:placeholder:text-white/30 dark:focus:border-brand-800`}
      />
